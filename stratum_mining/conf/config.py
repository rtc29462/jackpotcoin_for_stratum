...
CENTRAL_WALLET = 'JNLoeMCq7oCRXV17PkKM6mDKj9JmVnRLZA'   # Local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 15372
COINDAEMON_TRUSTED_USER = 'user'
COINDAEMON_TRUSTED_PASSWORD = 'pass'
...
PASSWORD_SALT = 'ILOVEYOUILOVEYOUILOVEYOUILOVEYOU'
...
NOTIFY_EMAIL_TO = 'mkimid@me.com'                              # Where to send Start/Found block notifications
NOTIFY_EMAIL_TO_DEADMINER = 'mkimid@me.com'                    # Where to send dead miner notifications
